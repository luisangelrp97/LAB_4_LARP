# -*- coding: utf-8 -*-
"""
Created on Wed May 13 15:34:51 2020
...
one, two, three = np.split(datos2.sample(frac=1), [int(.25*len(datos2)),int(.75*len(datos2))])
...
df_estacionalidad = pd.DataFrame(meanvar)
